            ...
            <div class="flex items-center justify-between gap-10 px-20">
                <div class="w-1/2 flex flex-col justify-center ">
                    ...
                    <div class="w-1/2 mt-10">
                        <a href="{{route('diagnosis.form')}}" class="items-center text-lg px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-full shadow-md hover:from-blue-600 hover:to-purple-600 ">                    
